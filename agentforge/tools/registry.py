...
class ToolBase(ABC):
    """Base class for agentforge tools."""
...
class ToolRegistry:
    ...
    def _load_tool_config(self) -> Dict[str, Any]:
        ...
        config_file = os.path.expanduser('~/.agentforge/tools_config.json')
    ...
    def _load_custom_tools(self):
        ...
        custom_tools_file = os.path.expanduser('~/.agentforge/custom_tools.json')
    ...
    def _save_custom_tools(self):
        ...
        try:
            ...
            custom_dir = os.path.expanduser('~/.agentforge')
