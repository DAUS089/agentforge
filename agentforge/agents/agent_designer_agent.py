...
class AgentDesignerAgent:
        ...
        try:
            ...
            if json_match:
                ...
                return AgentDesignResult(
                    ...
                    tools=self._convert_ai_tools_to_agentforge_tools(json_data.get('recommendedTools', [])),
    ...
    def _convert_ai_tools_to_agentforge_tools(self, ai_tools: List[str]) -> List[str]:
