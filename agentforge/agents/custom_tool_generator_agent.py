"""
Custom Tool Generator Agent for agentforge.
...
class CustomToolGeneratorAgent:
    ...
    def __init__(self, llm_config: Optional[Dict[str, Any]] = None):
        ...
        self.tools_directory = Path("/tmp/agentforge_custom_tools")
    ...
    def generate_custom_tool(self, user_description: str, show_code: bool = True, auto_confirm: bool = False) -> GeneratedToolResult:
        ...
        code_generation_task = Task(
            ...
            4. **ToolBase wrapper class** for agentforge registry integration
        ...
        try:
            ...
            if validation_passed:
                self._register_tool_with_agentforge(tool_file_path, tool_name)
            else:
    ...
    def _register_tool_with_agentforge(self, tool_file_path: str, tool_name: str):
        """Register the generated tool with agentforge tool registry."""
        try:
            print(f"📋 Registering {tool_name} with agentforge...")
