...
class MasterAgentCrew:
    ...
    def __init__(self, config: Config):
        ...
        self.config = config
        # Environment variable loading is disabled - use .agentforge/config.yaml only
    ...
    def _update_crew_execution_stats(self, crew_id: str, execution_time: int, status: str):
        ...
        stats_file = "/tmp/agentforge_execution_stats.pkl"
    ...
    def _load_analysis_cache(self):
        ...
        try:
            import pickle
            import os
            cache_file = "/tmp/agentforge_analysis_cache.pkl"
