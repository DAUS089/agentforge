"""
Intelligent Tool Creator for agentforge.
    ...
    def create_custom_tool(self, user_description: str, 
        ...
        try:
            ...
            if test_result["success"]:
                print("📋 Registering tool with agentforge...")
...
Generated by agentforge Intelligent Tool Creator
...
'''
    ...
    def _register_tool(self, tool: GeneratedTool, tool_file_path: str) -> Dict[str, Any]:
        """Register the tool with agentforge tool registry."""
        try:
